<div class="container-fluid">
 ...
 <div class="row m-2">
   <h3><i class="fas fa-users text-info"></i> Liste des sessions actives</h3>
...
<div class="table-responsive">
  <table id="idTableUsersSessions" class="table table-striped table-bordered table-hover">
...
<script src="/js/users_sessions.js" type="text/javascript"></script>
<!-- Container -->
</div>
