...
/* Projet Abls-Habitat version 4.4       Gestion d'habitat                                                24.08.2025 18:12:29 */
...
/******************************************************************************************************************************/
 void AUDIO_Send_to_zone ( gchar *audio_zone_name, gchar *audio_libelle )
  { if (!audio_zone_name) return;
    ...
    MQTT_Send_to_topic_new ( Partage->MQTT_local_session, AudioNode, FALSE, "AUDIO_ZONE/%s", audio_zone_name );
