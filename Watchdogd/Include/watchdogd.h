...
/************************************************ Définitions des prototypes **************************************************/
 ...
 extern void Thread_send_comm_to_master ( struct LIBRAIRIE *lib, gboolean etat );
 ...
 extern void Process_Unload_one_subprocess ( struct SUBPROCESS *module, struct LIBRAIRIE *lib );
