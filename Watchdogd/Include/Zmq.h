...
/************************************************ Définitions des prototypes **************************************************/
 ...
 extern void Zmq_Send_DI_to_master ( struct SUBPROCESS *module, JsonNode *di, gboolean etat );
 extern void Zmq_Send_AI_to_master ( struct SUBPROCESS *module, JsonNode *ai, gdouble valeur, gboolean in_range );
