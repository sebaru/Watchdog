...
extern void Proto_editer_mnemonique ( struct CLIENT *client, struct CMD_TYPE_MNEMONIQUE *rezo_mnemo );
 ...
 extern void Proto_ajouter_borne_modbus ( struct CLIENT *client, struct CMD_TYPE_BORNE_MODBUS *rezo_borne );
 extern void Proto_effacer_borne_modbus ( struct CLIENT *client, struct CMD_TYPE_BORNE_MODBUS *rezo_borne );
 extern void Proto_editer_borne_modbus ( struct CLIENT *client, struct CMD_TYPE_BORNE_MODBUS *rezo_borne );
 extern void Proto_valider_editer_borne_modbus ( struct CLIENT *client, struct CMD_TYPE_BORNE_MODBUS *rezo_borne );
