/**********************************************************************************************************/
/* Watchdogd/Include/Archivage.h        Déclaration structure internes des archivages                     */
/* Projet WatchDog version 2.0       Gestion d'habitat                      sam 08 jui 2006 12:02:36 CEST */
/* Auteur: LEFEVRE Sebastien                                                                              */
/**********************************************************************************************************/

#ifndef _ARCHIVAGE_H_
 #define _ARCHIVAGE_H_
...
/*************************************** Définitions des prototypes ***************************************/
 ...
 extern struct ARCHDB *Recuperer_archDB_suite( struct LOG *log, struct DB *db, SQLHSTMT hquery );

 extern gboolean Creer_db_arch ( struct LOG *log, struct DB *db );
#endif
/*--------------------------------------------------------------------------------------------------------*/
