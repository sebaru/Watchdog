...
/* Projet Abls-Habitat version 4.7       Gestion d'habitat                                    mar. 14 août 2012 19:05:42 CEST */
...
/*------------------------------------------------ Envoi vers API ------------------------------------------------------------*/
             ...
             else Info( __func__, "mqtt", msg->tech_id, LOG_ALERT, "Cannot send DLS_HISTO: memory error" );
/*---------------------------------------------------- Envoi IMSG ------------------------------------------------------------*/
