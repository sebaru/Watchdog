...
/* Projet Abls-Habitat version 4.7       Gestion d'habitat                                     mer. 09 mai 2012 12:44:56 CEST */
...
/******************************************************************************************************************************/
 void MQTT_Send_archive_to_API( gchar *tech_id, gchar *acronyme, gdouble valeur )
  { if (Config.instance_is_master == FALSE) return;                                  /* Les instances Slave n'archivent pas ! */
    ...
    Info( __func__, "archive", LOG_DEBUG, "Add Arch in list: '%s:%s'=%f", tech_id, acronyme, valeur );
    struct timeval tv;
