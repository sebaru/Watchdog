...
/* Projet Abls-Habitat version 4.7       Gestion d'habitat                                                01.11.2022 15:12:19 */
...
/******************************************************************************************************************************/
 void Dls_Save_Data_to_API ( struct DLS_PLUGIN *plugin )
  { if (!plugin)
    ...
    if (!RootNode)
    { Info( __func__, "dls", plugin->tech_id, LOG_ERR, "Error when saving dls_data to API." ); return; }
