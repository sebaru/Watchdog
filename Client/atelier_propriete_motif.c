...
/* Sortie: void                                                                                           */
/**********************************************************************************************************/
 void Proto_afficher_mnemo_atelier ( int tag, struct CMD_SHOW_MNEMONIQUE *mnemo )
...
/********************************************** Proprietes DLS ********************************************/
    ...
    texte = gtk_label_new( _("Control bit") );
    ...
    texte = gtk_label_new( _("Action bit") );
    ...
    texte = gtk_label_new( _("Action bit2") );
