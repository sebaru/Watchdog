...
/*---------------------------- Déclarations des prototypes de fonctions ----------------------------------*/
 ...
 extern void Proto_cacher_un_icone( struct CMD_ID_ICONE *icone );                   /* Dans liste_icone.c */
 extern void Proto_afficher_un_icone( struct CMD_SHOW_ICONE *icone );
 extern void Proto_rafraichir_un_icone( struct CMD_SHOW_ICONE *icone );
 extern void Proto_cacher_une_classe( struct CMD_ID_CLASSE *classe );
 ...
 extern void Proto_afficher_une_classe_atelier( struct CMD_SHOW_CLASSE *classe );
 extern void Proto_afficher_un_icone_atelier( struct CMD_SHOW_ICONE *icone );
 ...
 extern void Proto_afficher_une_entreeANA( struct CMD_TYPE_ENTREEANA *entree ); /* Dans liste_entreeana.c */
 extern void Proto_rafraichir_une_entreeANA( struct CMD_TYPE_ENTREEANA *entree );
 extern void Creer_page_entreeANA( void );

                                                                                /* Dans ajout_entreeana.c */
 extern void Menu_ajouter_editer_entreeANA ( struct CMD_TYPE_ENTREEANA *edit_entree );
