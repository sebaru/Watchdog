 ...
 */
 ...
 struct COURBE
  { guint actif;
    ...
    guint type;
    union
     { struct CMD_SHOW_ENTREEANA eana;                                            /* Libelle de la courbe */
...
/*---------------------------- Déclarations des prototypes de fonctions ----------------------------------*/
 ...
 extern void Menu_ajouter_editer_entreeANA ( struct CMD_EDIT_ENTREEANA *edit_entree );
 ...
 extern void Begin_print (GtkPrintOperation *operation,
                          ...
                          gpointer           user_data);
                                                                                         /* Dans courbe.c */
 extern void Proto_afficher_une_source_EA_for_courbe( struct CMD_SHOW_ENTREEANA *entreeANA );
