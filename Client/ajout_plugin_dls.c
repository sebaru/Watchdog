...
/* Projet WatchDog version 2.0       Gestion d'habitat                      sam 09 oct 2004 11:08:23 CEST */
...
/******************************************** Paramètres du plugin_dls ************************************/
    ...
    gtk_table_attach_defaults( GTK_TABLE(table), Check_actif, 0, 3, 1, 2 );
    ...
    else { gtk_toggle_button_set_active( GTK_TOGGLE_BUTTON(Check_actif), FALSE );
         }
