...
/* Projet WatchDog version 2.0       Gestion d'habitat                      jeu 25 sep 2003 14:26:52 CEST */
...
/********************************* Définitions des prototypes programme ***********************************/
 ...
 static struct CMD_EDIT_GROUPE Edit_groupe;                                  /* Groupe en cours d'edition */
/**********************************************************************************************************/
             ...
             { if (!edition)
                { struct CMD_ADD_GROUPE groupe;
                  ...
                  Envoi_serveur( TAG_UTILISATEUR, SSTAG_CLIENT_ADD_GROUPE,
                                 (gchar *)&groupe, sizeof(struct CMD_ADD_GROUPE) );
                }
               else
...
/* sortie: rien                                                                                           */
/**********************************************************************************************************/
 void Menu_ajouter_editer_groupe ( struct CMD_EDIT_GROUPE *edit_groupe )
  { GtkWidget *frame, *vboite, *table, *texte;

    if (edit_groupe)
     { memcpy( &Edit_groupe, edit_groupe, sizeof(struct CMD_EDIT_GROUPE) ); /*Save pour utilisation future*/
     }
    else memset (&Edit_groupe, 0, sizeof(struct CMD_EDIT_GROUPE) );                /* Sinon RAZ structure */
