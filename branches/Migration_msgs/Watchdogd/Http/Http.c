...
/******************************************************************************************************************************/
 static void WS_send_histo ( struct lws *wsi, struct CMD_TYPE_HISTO *histo )
  { struct WS_PER_SESSION_DATA *pss;
    ...
    json_builder_set_member_name  ( builder, "tech_id" );       json_builder_add_string_value ( builder, histo->msg.mnemo_base.dls_tech_id );
    json_builder_set_member_name  ( builder, "acronyme" );      json_builder_add_string_value ( builder, histo->msg.mnemo_base.acronyme );
    json_builder_set_member_name  ( builder, "libelle" );       json_builder_add_string_value ( builder, histo->msg.mnemo_base.libelle );
    json_builder_set_member_name  ( builder, "syn_groupe" );    json_builder_add_string_value ( builder, histo->msg.mnemo_base.syn_parent_page );
    json_builder_set_member_name  ( builder, "syn_page" );      json_builder_add_string_value ( builder, histo->msg.mnemo_base.syn_page );
    json_builder_set_member_name  ( builder, "dls_shortname" ); json_builder_add_string_value ( builder, histo->msg.mnemo_base.dls_shortname );
