...
/*---------------------------------------- Déclarations des prototypes de fonctions ------------------------------------------*/
 ...
 extern void Proto_editer_message ( struct CLIENT *client, struct CMD_TYPE_MNEMO_MESSAGE *rezo_msg );
 extern void Proto_valider_editer_message ( struct CLIENT *client, struct CMD_TYPE_MNEMO_MESSAGE *rezo_msg );
 extern void Proto_effacer_message ( struct CLIENT *client, struct CMD_TYPE_MNEMO_MESSAGE *rezo_msg );
 extern void Proto_ajouter_message ( struct CLIENT *client, struct CMD_TYPE_MNEMO_MESSAGE *rezo_msg );
