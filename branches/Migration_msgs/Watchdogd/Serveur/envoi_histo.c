    ...
    if (retour==FALSE)
     { struct CMD_GTK_MESSAGE erreur;
       g_snprintf( erreur.message, sizeof(erreur.message),
                   "Unable to ack histo %s:%s", rezo_histo->msg.mnemo_base.acronyme, rezo_histo->msg.mnemo_base.dls_tech_id );
       Envoi_client( client, TAG_GTK_MESSAGE, SSTAG_SERVEUR_ERREUR,
           ...
           if (result)
            ...
            { struct CMD_GTK_MESSAGE erreur;
              g_snprintf( erreur.message, sizeof(erreur.message),
                          "Unable to locate histo %s:%s", rezo_histo->msg.mnemo_base.acronyme, rezo_histo->msg.mnemo_base.dls_tech_id );
              Envoi_client( client, TAG_GTK_MESSAGE, SSTAG_SERVEUR_ERREUR,
                            (gchar *)&erreur, sizeof(struct CMD_GTK_MESSAGE) );
            }
         }
