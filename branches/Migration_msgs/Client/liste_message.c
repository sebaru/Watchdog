 ...
 static void Menu_exporter_message( void )
  { GtkSourcePrintCompositor *compositor;
    ...
    while ( valide  )                                            /* Pour tous les groupe_pages du tableau */
     { gchar chaine[128], pivot[80], *acronyme, *type_string, *groupe_page, *libelle;
       GtkTextIter iter_end;
       gboolean enable;
       gint len, sms;

       gtk_tree_model_get( store, &iter, COLONNE_ACTIVE, &enable, COLONNE_ACRONYME, &acronyme,
                           COLONNE_SMS, &sms,
       ...
       g_snprintf( chaine, sizeof(chaine), "%s - ", acronyme );
...
/***************************************** La liste des messages ******************************************/
    ...
    colonne = gtk_tree_view_column_new_with_attributes ( _("Acronyme"), renderer, "text", COLONNE_ACRONYME, NULL);
...
/**********************************************************************************************************/
 static void Rafraichir_visu_message( GtkTreeIter *iter, struct CMD_TYPE_MESSAGE *message )
  { GtkTreeModel *store;
    gchar audio[10], groupe_page[512];
    ...
    gtk_list_store_set ( GTK_LIST_STORE(store), iter,
                         ...
                         COLONNE_ACRONYME, message->acronyme,
