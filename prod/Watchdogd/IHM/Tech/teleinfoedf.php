<div class="container">
 ...
 <div class="row m-2">
   <h3><img src="/img/linky.jpg" style="width:80px" alt="Teleinfo E.D.F"> Configuration du module Téléinfo EDF sur <strong id='idTitleInstance'></strong></h3>
   ...
   <div class ="ml-auto btn-group align-items-start">
        ...
        <button type="button" onclick="TINFO_Reload()" class="btn btn-outline-warning"><i class="fas fa-redo"></i> Reload</button>
     ...
     <h4 class="alert-heading">Warning !</h4>
       ...
       <div class="col form-group">
					     <div class="input-group">
						     <label class="col-3 col-form-label text-right">Tech_ID</label>
       ...
       <div class="col form-group">
					     <div class="input-group">
						     <label class="col-3 col-form-label text-right">Retry in</label>
