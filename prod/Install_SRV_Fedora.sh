...
dnf install -y glib2-devel bison flex readline-devel giflib-devel libgcrypt-devel libxcrypt-devel
...
dnf install -y pulseaudio alsa-utils alsa-firmware mpg123 mpg123-plugins-pulseaudio
dnf install -y sox pocketsphinx
