...
apt-get install -y git libtool automake autoconf gcc
...
apt-get install -y libgnomeui-dev libgoocanvas-dev libgtksourceview2.0-dev libgtkdatabox-0.9.1-1-dev
