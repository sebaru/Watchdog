...
apt-get install -y sox libsox-fmt-all python3-pip
apt-get install -y libgnomeui-dev libgoocanvas-dev libgtksourceview2.0-dev libjson-glib-dev pocketsphinx libmosquitto-dev vlc 
pip3 install gTTS
