...
|
*/
$config['base_url'] = 'http://test.watchdog.fr/';
...
$config['sess_save_path'] = '/tmp/wtd-session';
...
$config['title']      = 'Admin Watchdog';
$config['title_mini'] = ' Watchdog';
$config['title_lg']   = ' Watchdog';
/*$config['web_service_host'] = 'test.abls-habitat.fr';*/
$config['web_service_host'] = 'localhost';
$config['environnement'] = 'developpement';
