<div class="container-fluid">
 ...
 <h3>Liste des Modules WAGO sur Modbus</h3>
   ...
   <div class ="ml-auto btn-group">
        ...
        <button type="button" onclick="Go_to_modbus_map()"class="btn btn-primary"><i class="fas fa-directions"></i> Map</button>
...
<script src="<?php echo base_url('js/modbus.js')?>" type="text/javascript"></script>
