<div class="container-fluid">
 ...
 <div class="row m-2">
   ...
   <div class ="ml-auto btn-group">
        <button type="button" onclick="Compiler()" class="btn btn-outline-success"><i class="fas fa-save"></i> Compiler</button>
        <button type="button" onclick="Go_to_run()"class="btn btn-primary"><i class="fas fa-eye"></i> RUN</button>
        <button type="button" onclick="Go_to_mnemo()" class="btn btn-primary"><i class="fas fa-book"></i> Mnemos</button>
...
<script src="<?php echo base_url('js/dls_source.js')?>" type="text/javascript"></script>
