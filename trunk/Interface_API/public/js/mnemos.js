 ...
 function Load_page ()
  { vars = window.location.pathname.split('/');
    ...
    $('#idTableEntreeAna').DataTable(
       { pageLength : 50,
         fixedHeader: true,
         ajax: {	url : "/api/mnemos/list/"+vars[4],	type : "GET", dataSrc: "AI",
                 error: function ( xhr, status, error ) { Show_Error(xhr.statusText); }
               },
         rowId: "id",
         columns: [ { "data": "tech_id",    "title":"TechId",     "className": "text-center hidden-xs" },
    ...
    $('#idTableSortieTor').DataTable(
       { pageLength : 50,
         fixedHeader: true,
         ajax: {	url : "/api/mnemos/list/"+vars[4],	type : "GET", dataSrc: "DO",
                 error: function ( xhr, status, error ) { Show_Error(xhr.statusText); }
               },
         rowId: "id",
         columns: [ { "data": "tech_id",    "title":"TechId",     "className": "text-center hidden-xs" },
    ...
    $('#idTableSortieAna').DataTable(
       { pageLength : 50,
         fixedHeader: true,
         ajax: {	url : "/api/mnemos/list/"+vars[4],	type : "GET", dataSrc: "AO",
                 error: function ( xhr, status, error ) { Show_Error(xhr.statusText); }
               },
         rowId: "id",
         columns: [ { "data": "tech_id",    "title":"TechId",     "className": "text-center hidden-xs" },
