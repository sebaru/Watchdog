  ...
  { gchar chaine[32], requete[4096];
    ...
    if (database_version < 2994)
     { g_snprintf( requete, sizeof(requete), "ALTER TABLE `mnemos` ENGINE = INNODB ROW_FORMAT = DYNAMIC;" );
       ...
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
       g_snprintf( requete, sizeof(requete), "ALTER TABLE mnemos_Tempo ADD FOREIGN KEY id_mnemo (`id_mnemo`) REFERENCES mnemos(`id`)"
                                             " ON DELETE CASCADE ON UPDATE RESTRICT;" );
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
       g_snprintf( requete, sizeof(requete), "ALTER TABLE `mnemos_DigitalInput` ENGINE = INNODB ROW_FORMAT = DYNAMIC;" );
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
       g_snprintf( requete, sizeof(requete), "ALTER TABLE mnemos_DigitalInput ADD FOREIGN KEY id_mnemo (`id_mnemo`) REFERENCES mnemos(`id`)"
                                             " ON DELETE CASCADE ON UPDATE RESTRICT;" );
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
       g_snprintf( requete, sizeof(requete), "ALTER TABLE `mnemos_AnalogInput` ENGINE = INNODB ROW_FORMAT = DYNAMIC;" );
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
       g_snprintf( requete, sizeof(requete), "ALTER TABLE mnemos_AnalogInput ADD FOREIGN KEY id_mnemo (`id_mnemo`) REFERENCES mnemos(`id`)"
                                             " ON DELETE CASCADE ON UPDATE RESTRICT;" );
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
       g_snprintf( requete, sizeof(requete), "ALTER TABLE `mnemos_CptImp` ENGINE = INNODB ROW_FORMAT = DYNAMIC;" );
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
       g_snprintf( requete, sizeof(requete), "ALTER TABLE mnemos_CptImp ADD FOREIGN KEY id_mnemo (`id_mnemo`) REFERENCES mnemos(`id`)"
                                             " ON DELETE CASCADE ON UPDATE RESTRICT;" );
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
       g_snprintf( requete, sizeof(requete), "ALTER TABLE `mnemos_CptHoraire` ENGINE = INNODB ROW_FORMAT = DYNAMIC;" );
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
       g_snprintf( requete, sizeof(requete), "ALTER TABLE mnemos_CptHoraire ADD FOREIGN KEY id_mnemo (`id_mnemo`) REFERENCES mnemos(`id`)"
                                             " ON DELETE CASCADE ON UPDATE RESTRICT;" );
       Lancer_requete_SQL ( db, requete );                                                     /* Execution de la requete SQL */
     }
