...
(79, 0, 38, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 37, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 36, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 35, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 34, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 33, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 32, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 31, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 30, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 29, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 28, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 27, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 26, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 25, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 24, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 23, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 22, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 21, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 20, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 19, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 18, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 17, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 16, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 15, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 14, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 13, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 12, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 11, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 10, 1, 'SYS_RESERVED', 'Reserved for internal use', ''),
(79, 0, 09, 1, 'SYS_RESERVED', 'Reserved for internal use', '');
...
CREATE TABLE IF NOT EXISTS `syns_pass` (
  ...
  `bitctrl3` int(11) NOT NULL DEFAULT '0',
  `angle` float NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
