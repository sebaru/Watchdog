...
CREATE TABLE IF NOT EXISTS `mnemos_DI` (
  ...
  `acronyme` VARCHAR(64) COLLATE utf8_unicode_ci NOT NULL,
  `libelle` text COLLATE utf8_unicode_ci NOT NULL DEFAULT 'default',
  `src_host` VARCHAR(40) COLLATE utf8_unicode_ci NULL DEFAULT '*',
  `src_thread` VARCHAR(20) COLLATE utf8_unicode_ci NULL DEFAULT '*',
  `src_text` VARCHAR(160) COLLATE utf8_unicode_ci NULL DEFAULT '',
  PRIMARY KEY (`id`),
  UNIQUE (`tech_id`,`acronyme`),
  FOREIGN KEY (`tech_id`) REFERENCES `dls` (`tech_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=INNODB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10000 ;
...
CREATE TABLE IF NOT EXISTS `mnemos_AI` (
  ...
  `src_host` VARCHAR(40) COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `src_thread` VARCHAR(20) COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `src_text` VARCHAR(160) COLLATE utf8_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mnemos_AO` (
  ...
  `dst_host` VARCHAR(40) COLLATE utf8_unicode_ci NOT NULL DEFAULT '*',
  `dst_thread` VARCHAR(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '*',
  `dst_text` VARCHAR(160) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  UNIQUE (`tech_id`,`acronyme`),
  FOREIGN KEY (`tech_id`) REFERENCES `dls` (`tech_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=INNODB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10000 ;
