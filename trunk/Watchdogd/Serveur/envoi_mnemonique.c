...
/* Sortie: Niet                                                                                           */
/**********************************************************************************************************/
 void Proto_editer_option_tempo ( struct CLIENT *client, struct CMD_TYPE_MNEMO_BASE *rezo_mnemo )
...
/* Sortie: Niet                                                                                           */
/**********************************************************************************************************/
 void Proto_editer_option_entreeANA ( struct CLIENT *client, struct CMD_TYPE_MNEMO_BASE *rezo_mnemo )
  { struct CMD_TYPE_OPTION_BIT_INTERNE option;
...
/* Sortie: Niet                                                                                           */
/**********************************************************************************************************/
 void Proto_editer_option_compteur_imp ( struct CLIENT *client, struct CMD_TYPE_MNEMO_BASE *rezo_mnemo )
  { struct CMD_TYPE_OPTION_BIT_INTERNE option;
