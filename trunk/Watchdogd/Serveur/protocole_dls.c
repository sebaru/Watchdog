...
/* Projet WatchDog version 3.0       Gestion d'habitat                      sam 04 avr 2009 11:19:27 CEST */
     ...
     { case SSTAG_CLIENT_WANT_PAGE_DLS:
       ...
       case SSTAG_CLIENT_VALIDE_EDIT_SOURCE_DLS_FIN:
             { struct CMD_TYPE_SOURCE_DLS *edit_dls;
               ...
               Save_source_dls_to_DB ( edit_dls->tech_id, client->Source_DLS_new, client->taille_Source_DLS_new );
