...
/******************************************************************************************************************************/
    ...
    $this->data['classes'] = $this->Icons_model->class_list();                                               /* Get all class */
 			...
 			if($this->form_validation->run())
			  { $params = array( 'libelle'    => $this->input->post('libelle'),
                        'type'       => $this->input->post('type_icone'),
...
/******************************************************************************************************************************/
    ...
    $config['allowed_types']        = 'gif|svg|01|02|03|04|05|06|07|08|09|10|11|12|13|14|15|16';
    if ($icon->nbr_matrice==0)
     { $config['file_name']            = $icon->id.'.'.$icon->type; }
    else
     { $config['file_name']            = $icon->id.'.'.$icon->type.sprintf(".%02d", $icon->nbr_matrice); }
