...
<header>
  ...
  <a class="navbar-brand" href="wiki.abls-habitat.fr"><img src="<?php echo base_url('/svg/logo.svg')?>" alt="Watchdog Logo" width=50></a>
...
<footer class="page-footer bg-info mt-2 pt-0">
  ...
  <!-- Copyright -->
    ...
    <script src="<?php echo base_url('js/install/install.js')?>" type="text/javascript"></script>
