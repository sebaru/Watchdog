 ...
 var Div_Ctrl_panel_Motif=
       ...
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-posx" type="number" min="0" step="10" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Posy</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-posy" type="number" min="0" step="10" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Scale</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-scale" type="number" min="0.2" max="5" step="0.1" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Angle</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-angle" type="number" min="0" max="360" step="5" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Default Color</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-color" type="color" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Control Tech_id</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-tech-id" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Control Acronyme</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-acronyme" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Clic Tech_id</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-clic-tech-id" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Clic Acronyme</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-clic-acronyme" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Access Level</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-access-level" type="number" min="0" max="9" step="1" onchange="Change_motif_properties()"/> </div>'+
       '<div class="col-sd-1"><label>Libellé</label></div>'+
       '<div class="col-sd-1"><input id="WTD-ctrl-panel-motif-libelle" onchange="Change_motif_properties()"/> </div>';
