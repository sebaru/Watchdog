 ...
 */
$config['site_title']                 = "traderssquare.net";       // Site Title, example.com
$config['admin_email']                = "admin@traderssquare.net"; // Admin Email, admin@example.com
...
$config['message_end_delimiter']   = '</span><br>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<span>';		// Error message start delimiter
$config['error_end_delimiter']     = '</span><br>';	// Error message end delimiter
